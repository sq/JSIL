  ...
  "System.Linq.Enumerable", function ($) {
      $.Method({ Static: true, Public: true }, "Any",
        ...
        function (T, enumerable) {
            ...
            var moveNext = System.Collections.IEnumerator.$Methods.MoveNext.InterfaceMethod;
      ...
      $.Method({ Static: true, Public: true }, "Any",
        ...
        function (T, enumerable, predicate) {
            ...
            var moveNext = System.Collections.IEnumerator.$Methods.MoveNext.InterfaceMethod;
            var get_Current = tIEnumerator.$Methods.get_Current.InterfaceMethod;
      ...
      var lastImpl = function (T, enumerable, predicate) {
        ...
        if (list !== null) {
          var item = IList.$Methods.get_Item.InterfaceMethod;
      ...
      $.Method({ Static: true, Public: true }, "SelectMany",
        ...
        function SelectMany$b2(TSource, TResult, source, selector) {
            ...
            var moveNext = System.Collections.IEnumerator.$Methods.MoveNext.InterfaceMethod;
            var get_Current = tIEnumerator.$Methods.get_Current.InterfaceMethod;
            var get_CurrentResult = tIEnumeratorResult.$Methods.get_Current.InterfaceMethod;
      ...
      $.Method({ Static: true, Public: true }, "Zip",
        ...
        function (TFirst, TSecond, TResult, first, second, combiner) {
          ...
          var moveNext = System.Collections.IEnumerator.$Methods.MoveNext.InterfaceMethod;
          var get_Current1 = tIEnumerator1.$Methods.get_Current.InterfaceMethod;
          var get_Current2 = tIEnumerator2.$Methods.get_Current.InterfaceMethod;
      ...
      $.Method({ Static: true, Public: true }, "Cast",
       ...
       function (TResult, enumerable) {
           ...
           var moveNext = System.Collections.IEnumerator.$Methods.MoveNext.InterfaceMethod;
           var get_Current = System.Collections.IEnumerator.$Methods.get_Current.InterfaceMethod;
      ...
      function Sum_Int32(enumerable) {
          ...
          var moveNext = $jsilcore.System.Collections.IEnumerator.$Methods.MoveNext.InterfaceMethod;
          var getCurrent = $jsilcore.System.Collections.Generic.IEnumerator$b1.Of($jsilcore.System.Int32).$Methods.get_Current.InterfaceMethod;
      ...
      function Sum_Single(enumerable) {
          ...
          var moveNext = $jsilcore.System.Collections.IEnumerator.$Methods.MoveNext.InterfaceMethod;
          var getCurrent = $jsilcore.System.Collections.Generic.IEnumerator$b1.Of($jsilcore.System.Single).$Methods.get_Current.InterfaceMethod;
      ...
      function Sum_Double(enumerable) {
          ...
          var moveNext = $jsilcore.System.Collections.IEnumerator.$Methods.MoveNext.InterfaceMethod;
          var getCurrent = $jsilcore.System.Collections.Generic.IEnumerator$b1.Of($jsilcore.System.Double).$Methods.get_Current.InterfaceMethod;
