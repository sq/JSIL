    ...
    public class JavascriptAstEmitter : JSAstVisitor {
        ...
        public override void VisitNode (JSNode node) {
            if ((node != null) && !node.IsNull) {
                ...
                Output.Identifier("JSIL.UntranslatableNode", (EscapingMode?)null);
                Output.LPar();
        ...
        public void VisitNode (JSGotoExpression go) {
            ...
            Output.Identifier("JSIL.UntranslatableInstruction", (EscapingMode?) null);
            Output.LPar();
        ...
        public void VisitNode (JSPassByReferenceExpression byref) {
            ...
            if (JSReferenceExpression.TryMaterialize(JSIL, byref.Referent, out referent)) {
				...
				Output.Identifier("JSIL.UnmaterializedReference",(EscapingMode?) null);
                Output.LPar();
            ...
            try {
                if (isOverloaded) {
                    ...
                    Action genericArgs = () => {
						...
						Output.Identifier("null", (EscapingMode?)null);
                    };
                    ...
                    if (isStatic) {
                        ...
                        Visit(invocation.Type);
                        Output.Dot();
						Output.Identifier("prototype", (EscapingMode?)null);
                        Output.Comma();
                    ...
                    if (isStatic) {
                        ...
                        Visit(invocation.Method);
                        Output.Dot();
						Output.Identifier("call",(EscapingMode?) null);
                        Output.LPar();
